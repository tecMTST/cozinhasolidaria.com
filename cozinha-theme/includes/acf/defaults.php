...
function cozinha_solidaria_home_default($field_name)
{
    ...
    $defaults = array(
        ...
        'home_gallery_images' => array(
            array('image_url' => $asset('/img/cozinha-solidaria-1.jpg')),
            array('image_url' => $asset('/img/cozinha-solidaria-2.jpg')),
            array('image_url' => $asset('/img/cozinha-solidaria-3.jpg')),
            array('image_url' => $asset('/img/cozinha-solidaria-4.jpg')),
            array('image_url' => $asset('/img/cozinha-solidaria-5.jpg')),
            array('image_url' => $asset('/img/cozinha-solidaria-6.jpg')),
        ),
        ...
        'home_videos' => array(
            array('youtube_id' => 'NObqUoVIXPU', 'thumbnail_url' => $asset('/img/thumb-video01.jpg')),
            array('youtube_id' => 'ftXWFGSBQh8', 'thumbnail_url' => $asset('/img/thumb-video02.jpg')),
            array('youtube_id' => 'aAtwYdNzgOc', 'thumbnail_url' => $asset('/img/thumb-video03.jpg')),
        ),
        ...
        'home_accountability_paragraphs' => array(
            ...
            array('text' => '<strong>Em pouco mais de dois anos, já foram servidas mais de 5.800.000 quentinhas e mais de 3.800.000 quilos de alimentos distribuídos para que milhares de famílias garantam, ao menos, uma refeição rica em nutrientes por dia.</strong>'),
        ),
        'home_accountability_stats' => array(
            array('number' => '5.800.000', 'label' => 'refeições'),
            array('number' => '55', 'label' => 'Cozinhas Solidárias pelo Brasil'),
            array('number' => '14', 'label' => 'Estados'),
            array('number' => '97', 'label' => 'Cozinheiras'),
            array('number' => '3.800.000', 'label' => 'quilos de alimentos'),
        ),
