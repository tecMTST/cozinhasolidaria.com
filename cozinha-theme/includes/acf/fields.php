...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array('key' => 'field_project_header_tab', 'label' => 'Topo', 'type' => 'tab', 'placement' => 'top'),
            array(
                'key' => 'field_project_header_intro',
                'label' => 'Texto do topo',
                'name' => 'project_header_intro',
                'type' => 'wysiwyg',
                'tabs' => 'all',
                'toolbar' => 'full',
                'media_upload' => 0,
                'default_value' => cozinha_solidaria_project_default('project_header_intro'),
            ),
            array('key' => 'field_project_more_food_tab', 'label' => 'Mais que comida', 'type' => 'tab', 'placement' => 'top'),
            array(
                'key' => 'field_project_more_food_title',
                'label' => 'Titulo',
                'name' => 'project_more_food_title',
                'type' => 'text',
                'default_value' => cozinha_solidaria_project_default('project_more_food_title'),
            ),
            array(
                'key' => 'field_project_more_food_content',
                'label' => 'Texto',
                'name' => 'project_more_food_content',
                'type' => 'wysiwyg',
                'tabs' => 'all',
                'toolbar' => 'full',
                'media_upload' => 0,
                'default_value' => cozinha_solidaria_project_default('project_more_food_content'),
            ),
            array('key' => 'field_project_support_tab', 'label' => 'Quem faz acontecer', 'type' => 'tab', 'placement' => 'top'),
            array(
                'key' => 'field_project_support_title',
                'label' => 'Titulo',
                'name' => 'project_support_title',
                'type' => 'text',
                'default_value' => cozinha_solidaria_project_default('project_support_title'),
            ),
            array(
                'key' => 'field_project_support_content',
                'label' => 'Texto',
                'name' => 'project_support_content',
                'type' => 'wysiwyg',
                'tabs' => 'all',
                'toolbar' => 'full',
                'media_upload' => 0,
                'default_value' => cozinha_solidaria_project_default('project_support_content'),
            ),
            array('key' => 'field_project_support_button_text', 'label' => 'Texto do botao', 'name' => 'project_support_button_text', 'type' => 'text', 'default_value' => cozinha_solidaria_project_default('project_support_button_text')),
            array('key' => 'field_project_support_button_link', 'label' => 'Link do botao', 'name' => 'project_support_button_link', 'type' => 'text', 'default_value' => cozinha_solidaria_project_default('project_support_button_link')),
        ),
        'location' => array(
            array(
                array(
